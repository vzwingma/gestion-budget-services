...
public class SimpleWeakEncryption {
     ...
     * @param salt     the salt, can be {@code null}. But it is highly recommended
     ...
     * @throws RuntimeException which wraps {@link java.io.UnsupportedEncodingException} in case the
     ...
     * @throws RuntimeException which wraps {@link java.security.NoSuchAlgorithmException} in case the
