...
package android.finances.terrier.com.budget.lockpattern.widget;
...
import android.finances.terrier.com.budget.lockpattern.util.FloatAnimator;
...
public class LockPatternView extends View {
    ...
    public LockPatternView(Context context, AttributeSet attrs) {
        ...
        mRegularColor = getResources().getColor(R.color.alp_42447968_lock_pattern_view_regular_light);
        mErrorColor = getResources().getColor(R.color.alp_42447968_lock_pattern_view_error_light);
        mSuccessColor = getResources().getColor(R.color.alp_42447968_lock_pattern_view_success_light);
    ...
    private static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link android.finances.terrier.com.budget.lockpattern.widget.LockPatternView#onSaveInstanceState()}
         */
