...
public class AlpSettings {
     ...
     * (such as {@link android.preference.PreferenceActivity}, {@link android.preference.PreferenceFragment}...).
     *
     * @param context the context.
     * @param pm      {@link android.preference.PreferenceManager}.
     * @since v2.6 beta
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    ...
    public static class Security {
         ...
         *
         * @param context the context.
         * @param clazz   the encrypter class, can be {@code null} if you don't want
         *                to use it.
         */
         ...
         *
         * @param context the context.
         * @param clazz   the full name of encrypter class, can be {@code null} if
