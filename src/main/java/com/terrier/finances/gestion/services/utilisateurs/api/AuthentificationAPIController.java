...
public class AuthentificationAPIController {
	...
	@PostMapping(value=BudgetApiUrlEnum.AUTH_AUTHENTICATE)
	public @ResponseBody AuthentificationRestObject authenticate(@RequestBody AuthentificationRestObject auth) throws UserNotAuthorizedException{
