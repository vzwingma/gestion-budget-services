...
public class BudgetMensuelPage extends AbstractUIComponent<BudgetMensuelController> {
	...
	private HorizontalLayout buildHorizontalLayout_1() {
		...
		buttonStatis.setCaption("Statistiques");
		buttonStatis.setImmediate(true);
		buttonStatis.setWidth("-1px");
		buttonStatis.setHeight("-1px");
		horizontalLayout_1.addComponent(buttonStatis);
		horizontalLayout_1.setComponentAlignment(buttonStatis,
				new Alignment(34));
	...
	private HorizontalLayout buildBudgetMensuel() {
		...
		budgetMensuel.setImmediate(true);
	...
	private VerticalLayout buildVerticalLayoutResume() {
		...
		verticalLayoutResume.setImmediate(true);
		...
		tableTotalResume.setImmediate(true);
	...
	private VerticalLayout buildVerticalLayoutDepenses() {
		...
		verticalLayoutDepenses.setImmediate(true);
		...
		tableSuiviDepense.setImmediate(true);
	...
	private HorizontalLayout buildHorizontalLayout_2() {
		...
		labelLastConnected.setImmediate(true);
		labelLastConnected.setWidth("-1px");
		labelLastConnected.setHeight("-1px");
		horizontalLayout_2.addComponent(labelLastConnected);
		horizontalLayout_2.setComponentAlignment(labelLastConnected,
				new Alignment(9));
		...
		buttonRefreshMonth.setImmediate(true);
	...
	private HorizontalLayout buildHorizontalLayoutActions() {
		...
		horizontalLayoutActions.setImmediate(false);
		...
		buttonEditer.setImmediate(true);
		...
		buttonAnnuler.setImmediate(true);
		...
		buttonCreate.setImmediate(true);
