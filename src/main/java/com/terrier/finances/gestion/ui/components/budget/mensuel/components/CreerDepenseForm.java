...
public class CreerDepenseForm extends AbstractUIComponent<CreerDepenseController> {
	...
	@AutoGenerated
	private AutocompleteField<String> textFieldDescription;
	...
	@AutoGenerated
	private ListSelect<String> listSelectComptes;
	 ...
	 */
	public AutocompleteField<String> getTextFieldDescription() {
	 ...
	 */
	public ListSelect<String> getListSelectComptes() {
	...
	private HorizontalLayout buildHorizontalLayout_8() {
		...
		// listSelectComptes
		listSelectComptes = new ListSelect<String>();
