...
import com.terrier.finances.gestion.ui.controler.budget.mensuel.ActionsLigneBudgetController;
...
public class ActionsLigneBudget extends AbstractUIComponent<ActionsLigneBudgetController> {
	...
	private HorizontalLayout buildMainLayout() {
		...
		buttonPrevue.setImmediate(true);
		...
		buttonReporter.setImmediate(true);
		...
		buttonSupprime.setImmediate(true);
