...
import com.terrier.finances.gestion.services.communs.api.config.SecurityOIdCConfig;
import com.terrier.finances.gestion.services.communs.api.interceptors.IncomingRequestInterceptor;

@Configuration
@ContextConfiguration(classes={TestMockBudgetServiceConfig.class, SecurityOIdCConfig.class, IncomingRequestInterceptor.class})
